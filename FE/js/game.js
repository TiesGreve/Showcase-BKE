...
joinButton.addEventListener("click", async (e) => {
    ...
    if(result != null){
        ...
        document.getElementById("player2-name").innerText = await ApiHandeler.GetUsername(result.user2);
...
async function Game(){
    ...
    if(document.getElementById("player2-name").innerText == "name...") document.getElementById("player2-name").innerText = await ApiHandeler.GetUsername(game.user2);
